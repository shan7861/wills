...
<meta name="viewport" content="width=device-width, initial-scale=1">
  ...
  <body>
	...
	<form action="../singleconfirm.php" method="post">
	<br>
		<fieldset id="field2">
			<legend><b>Member ID: <span style="color:red">*</span><a href="#" class="tip"><img src="helpicon.png" alt="HELP" width="20" height="20"> <span> Member ID is going to be an unique value, this is how their information will be linked in our system. So we can go back and search for their data to generate a will. </span> </a> </b></legend>
			<p>
				<label>
